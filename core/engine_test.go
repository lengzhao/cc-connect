...
func TestProcessInteractiveEvents_EmitsProcessingHookForQueuedMessage(t *testing.T) {
	...
	go func() {
		e.processInteractiveEvents(state, session, e.sessions, key, "turn1", time.Now(), nil, sendDone, "ctx-turn1", turnStages{})
		close(done)
	}()
...
func TestProcessInteractiveEvents_SuppressesDuplicateSideChannelText(t *testing.T) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m1", time.Now(), nil, nil, nil, turnStages{})
...
func TestProcessInteractiveEvents_StripsAgentFooterWhenEnabled(t *testing.T) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-agent-footer", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_KeepsAgentFooterByDefault(t *testing.T) {
	...
	agentSession.events <- Event{Type: EventResult, Done: true}
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-agent-footer-default", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_AppendsReplyFooterWhenEnabled(t *testing.T) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-footer", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_AppendsContextIndicatorInsideReplyFooter(t *testing.T) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-footer-context", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_ToolSegmentsKeepFinalFooter(t *testing.T) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-tool-footer", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_DropsStandaloneEllipsisProgress(t *testing.T) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-ellipsis", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_AddsDoneReactionAfterNormalReply(t *testing.T) {
	...
	agentSession.events <- Event{Type: EventResult, Content: "done", Done: true}
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-done", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_DoesNotAppendReplyFooterWhenDisabled(t *testing.T) {
	...
	agentSession.events <- Event{Type: EventResult, Content: "answer", Done: true}
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-footer-off", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_ReplyFooterPrefersSessionRuntimeState(t *testing.T) {
	...
	agentSession.events <- Event{Type: EventResult, Content: "answer", Done: true}
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-footer-runtime", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_SuppressesReplyFooterWhenOnlyWorkDir(t *testing.T) {
	...
	agentSession.events <- Event{Type: EventResult, Content: "answer", Done: true}
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-footer-workdir-only", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_CompactProgressCoalescesThinkingAndToolUse(t *testing.T) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m1", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_CardProgressUsesCardTemplate(t *testing.T) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m2", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_FinalReplyUsesWorkspaceForReferenceRendering(t *testing.T) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-relative", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_FinalReplyRemainsRawWhenReferencesDisabled(t *testing.T) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-relative-raw", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_CardProgressUsesStructuredPayloadWhenSupported(t *testing.T) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m3", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_RichCardShowsThinkingContent(t *testing.T) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-rich-thinking", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_RichCardCoalescesToolResult(t *testing.T) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-rich-tool-result", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_RichCardResolvesMarkdownImages(t *testing.T) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-rich-image-resolver", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func runRichCardSilentScenario(t *testing.T, name string, chunks []string, finalContent string) (starts, streams, updates []string, deletes int) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-rich-silent-"+name, time.Now(), nil, nil, state.replyCtx, turnStages{})
	return p.snapshot()
}
...
func TestProcessInteractiveEvents_RichCard_TextThenNoReply_PreservesBody(t *testing.T) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-rich-text-then-noreply", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_RichCard_ToolThenNoReply(t *testing.T) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-rich-tool-then-noreply", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestProcessInteractiveEvents_AskUserQuestionFromAgent_RendersRichCardPrompt(t *testing.T) {
	...
	go func() {
		e.processInteractiveEvents(state, session, e.sessions, key, "m-codex-ask-card", time.Now(), nil, sendDone, nil, turnStages{})
		close(done)
	}()
...
func TestProcessInteractiveEvents_AskUserQuestionApproveAllAutoApproves(t *testing.T) {
	...
	go func() {
		e.processInteractiveEvents(state, session, e.sessions, key, "m-ask-approve-all", time.Now(), nil, nil, nil, turnStages{})
		close(done)
	}()
...
func TestProcessInteractiveEvents_AskUserQuestionFromAgent_RendersLegacyPrompt(t *testing.T) {
	...
	go func() {
		e.processInteractiveEvents(state, session, e.sessions, key, "m-codex-ask-legacy", time.Now(), nil, sendDone, nil, turnStages{})
		close(done)
	}()
...
func TestProcessInteractiveEvents_PermissionWhileSendBlocked(t *testing.T) {
	...
	go func() {
		e.processInteractiveEvents(state, session, e.sessions, key, "m1", time.Now(), nil, sendDone, nil, turnStages{})
		close(done)
	}()
...
func TestProcessInteractiveEvents_DrainsQueuedMessages(t *testing.T) {
	...
	go func() {
		e.processInteractiveEvents(state, session, e.sessions, key, "msg1", time.Now(), nil, sendDone, nil, turnStages{})
		close(done)
	}()
...
func TestProcessInteractiveEvents_DrainsQueuedMessagesFIFOWithCreateTimes(t *testing.T) {
	...
	go func() {
		e.processInteractiveEvents(state, session, e.sessions, key, "msg0", time.Now(), nil, sendDone, "ctx-turn1", turnStages{})
		close(done)
	}()
...
func TestProcessInteractiveEvents_QueuedMessageUsesItsOwnReplyCtx(t *testing.T) {
	...
	go func() {
		e.processInteractiveEvents(state, session, e.sessions, key, "msg1", time.Now(), nil, sendDone, "ctx-turn1", turnStages{})
		close(done)
	}()
...
func TestAutoCompress_TriggerAfterResult(t *testing.T) {
	...
	go e.processInteractiveEvents(state, session, e.sessions, key, "msg1", time.Now(), func() {}, nil, nil, turnStages{})
...
func TestExecuteCardAction_CronEnable(t *testing.T) {
	...
	_ = store.Add(&CronJob{ID: "job1", CronExpr: "0 9 * * *", Enabled: false, SessionKey: "test:user1"})
	scheduler := NewCronScheduler(store)
	e.cronScheduler = scheduler
...
func TestExecuteCardAction_CronDisable(t *testing.T) {
	...
	_ = store.Add(&CronJob{ID: "job1", CronExpr: "0 9 * * *", Enabled: true, SessionKey: "test:user1"})
	scheduler := NewCronScheduler(store)
	e.cronScheduler = scheduler
...
func TestExecuteCardAction_CronDelete(t *testing.T) {
	...
	_ = store.Add(&CronJob{ID: "del-job", CronExpr: "0 9 * * *", Enabled: true, SessionKey: "test:user1"})
	scheduler := NewCronScheduler(store)
	e.cronScheduler = scheduler
...
func TestExecuteCardAction_CronMuteUnmute(t *testing.T) {
	...
	_ = store.Add(&CronJob{ID: "mute-job", CronExpr: "0 9 * * *", Enabled: true, SessionKey: "test:user1"})
	scheduler := NewCronScheduler(store)
	e.cronScheduler = scheduler
...
func TestCmdStop_ReturnsWhileCloseBlockedAndStopsEventLoop(t *testing.T) {
	...
	go func() {
		e.processInteractiveEvents(state, session, e.sessions, key, "msg-1", time.Now(), nil, nil, "ctx", turnStages{})
		close(done)
	}()
...
func TestBuildSenderPrompt_Enabled(t *testing.T) {
	...
	result := e.buildAgentPrompt("hello world", "user123", "Alice", "", "feishu", "feishu:channel42:user123", "", nil, AgentContext{}, nil)
...
func TestBuildSenderPrompt_Disabled(t *testing.T) {
	...
	result := e.buildAgentPrompt("hello", "user1", "Alice", "", "feishu", "feishu:ch:user1", "", nil, AgentContext{}, nil)
	if result != "hello" {
...
func TestBuildSenderPrompt_EmptyUserID(t *testing.T) {
	...
	result := e.buildAgentPrompt("hello", "", "Bob", "", "telegram", "telegram:ch:user1", "", nil, AgentContext{}, nil)
	if result != "hello" {
...
func TestBuildSenderPrompt_EmptyUserName(t *testing.T) {
	...
	result := e.buildAgentPrompt("hello", "user1", "", "", "feishu", "feishu:ch:user1", "", nil, AgentContext{}, nil)
...
func TestBuildSenderPrompt_NameWithSpaces(t *testing.T) {
	...
	result := e.buildAgentPrompt("hi", "U999", "Jim Tang", "", "slack", "slack:C012:U999", "", nil, AgentContext{}, nil)
...
func TestBuildSenderPrompt_IncludesEmailWhenProvided(t *testing.T) {
	...
	result := e.buildAgentPrompt("hi", "U999", "Jim Tang", "jim@example.com", "slack", "slack:C012:U999", "", nil, AgentContext{}, nil)
...
func TestBuildSenderPrompt_DifferentPlatforms(t *testing.T) {
	...
	for _, tc := range platforms {
		result := e.buildAgentPrompt("msg", "uid", "TestUser", "", tc.platform, tc.sessionKey, "", nil, AgentContext{}, nil)
...
func TestBuildSenderPrompt_SanitizesSpecialChars(t *testing.T) {
	...
	result := e.buildAgentPrompt("hi", "U1", "Evil\"Name\nInject", "", "slack", "slack:C1:U1", "", nil, AgentContext{}, nil)
...
func TestBuildSenderPrompt_ChannelKeyOverridesSessionKey(t *testing.T) {
	...
	result := e.buildAgentPrompt("hello", "staff1", "Alice", "", "dingtalk", "dingtalk:g:cidXXX:staff1", "cidXXX", nil, AgentContext{}, nil)
...
func TestBuildSenderPrompt_FallbackWithoutChannelKey(t *testing.T) {
	...
	result := e.buildAgentPrompt("hello", "staff1", "Alice", "", "dingtalk", "dingtalk:g:cidXXX:staff1", "", nil, AgentContext{}, nil)
	expected := "[cc-connect sender_id=staff1 sender_name=\"Alice\" platform=dingtalk chat_id=cidXXX]\nhello"
	if result != expected {
		t.Fatalf("got %q, want %q", result, expected)
	}
...
func TestBuildAgentPrompt_InjectTimestamp(t *testing.T) {
	e := newTestEngine()
	...
	if !strings.HasSuffix(result, "\nhello") {
		t.Fatalf("expected content suffix, got %q", result)
	}
}
...
type stubIMChannelPlatform struct{}

func (stubIMChannelPlatform) Name() string                             { return "lark" }
func (stubIMChannelPlatform) Start(MessageHandler) error               { return nil }
func (stubIMChannelPlatform) Reply(context.Context, any, string) error { return nil }
func (stubIMChannelPlatform) Send(context.Context, any, string) error  { return nil }
func (stubIMChannelPlatform) Stop() error                              { return nil }
func (stubIMChannelPlatform) PromptChannelAttrs(replyCtx any) []string {
	return []string{"channel_id=oc_group", "thread_id=omt_topic"}
}

func TestBuildSenderPrompt_IMChannelProviderUsesStableIds(t *testing.T) {
	e := newTestEngine()
	e.SetInjectSender(true)

	result := e.buildAgentPrompt(
		"hello",
		"ou_user",
		"Alice",
		"",
		"lark",
		"lark:oc_group:root:om_root",
		"oc_group",
		stubIMChannelPlatform{},
		AgentContext{},
		nil,
	)
	expected := "[cc-connect sender_id=ou_user sender_name=\"Alice\" platform=lark channel_id=oc_group thread_id=omt_topic]\nhello"
	if result != expected {
		t.Fatalf("got %q, want %q", result, expected)
	}
}
...
func TestBuildAgentPrompt_InjectTimestampUsesPlatformTimezone(t *testing.T) {
	e := newTestEngine()
	e.SetInjectTimestamp(true)
	result := e.buildAgentPrompt("hello", "U1", "", "", "stub", "stub:C1:U1", "", stubTZPlatform{tz: "America/New_York"}, AgentContext{}, nil)
	if !strings.Contains(result, `timezone="America/New_York"`) {
		t.Fatalf("expected platform timezone, got %q", result)
	}
}

func TestBuildAgentPrompt_InjectContextAllowlist(t *testing.T) {
	e := newTestEngine()
	e.SetInjectContext([]string{"language", "task_id", "custom.tenant_id"})
	ctx := AgentContext{
		Language: "zh",
		TaskID:   "task-42",
		TraceID:  "should-drop",
	...
	result := e.buildAgentPrompt("hello", "u1", "Alice", "", "chat-api", "chat-api:ch:u1", "ch", nil, ctx, nil)
...
func TestBuildAgentPrompt_InjectContextDisabled(t *testing.T) {
	...
	result := e.buildAgentPrompt("hello", "u1", "", "", "chat-api", "chat-api:ch:u1", "", nil, ctx, nil)
	if result != "hello" {
		t.Fatalf("expected raw content when inject_context unset, got %q", result)
	}
}

func TestBuildAgentPrompt_InjectContextWithSender(t *testing.T) {
	e := newTestEngine()
	e.SetInjectSender(true)
	e.SetInjectContext([]string{"task_id"})
	result := e.buildAgentPrompt("hi", "U1", "Rock", "", "slack", "slack:C1:U1", "", nil, AgentContext{TaskID: "job-9"}, nil)
...
func TestEventIdleTimeout_CleansUpSession(t *testing.T) {
	...
	go func() {
		e.processInteractiveEvents(state, session, e.sessions, key, "", time.Now(), nil, nil, nil, turnStages{})
		close(done)
	}()
...
func TestEventsNeedResync_ClearedOnCleanResult(t *testing.T) {
	...
	sendDone := make(chan error, 1)
	sendDone <- nil
	e.processInteractiveEvents(state, session, sessions, "test:resync:u1", "", time.Now(), nil, sendDone, "ctx", turnStages{})
...
func TestProcessInteractiveEvents_StreamingCard_BareNoReply_Suppressed(t *testing.T) {
	...
	e.processInteractiveEvents(state, session, e.sessions, sessionKey, "m-streamcard-bare-noreply", time.Now(), nil, nil, state.replyCtx, turnStages{})
...
func TestTurnCompleteLogsLatencyStages(t *testing.T) {
	prev := slog.Default()
	...
	p := &stubPlatformEngine{n: "test"}
	sess := newQueuingSession("qs-latency-stages")
	agent := &controllableAgent{nextSession: sess}
	e := NewEngine("test", agent, []Platform{p}, "", LangEnglish)

	key := "test:latency-stages"
	session := e.sessions.GetOrCreateActive(key)
	state := &interactiveState{
		agentSession: sess,
		platform:     p,
	...
	// Simulate 1.5s of dispatch/busy-queue wait before the turn started.
	received := time.Now().Add(-1500 * time.Millisecond)
	done := make(chan struct{})
	go func() {
		e.processInteractiveEvents(state, session, e.sessions, key, "turn1", time.Now(), nil, sendDone, "ctx", turnStages{receivedAt: received})
		close(done)
	}()
	select {
	case <-done:
	...
	qw, ok := summary["queue_wait_ms"].(float64)
	if !ok || qw < 1000 {
		t.Fatalf("queue_wait_ms = %v, want >= 1000", summary["queue_wait_ms"])
	}
	for _, field := range []string{"hook_ms", "first_event_ms"} {
		if _, ok := summary[field]; !ok {
			t.Fatalf("turn complete missing %s: %v", field, summary)
		}
	}
}

func TestQueueStageWait(t *testing.T) {
	turnStart := time.Now()
	if got := queueStageWait(time.Time{}, turnStart); got != 0 {
		t.Fatalf("zero receivedAt must yield 0, got %v", got)
	}
	if got := queueStageWait(turnStart.Add(time.Second), turnStart); got != 0 {
		t.Fatalf("receivedAt after turnStart must yield 0, got %v", got)
	}
	received := turnStart.Add(-1500 * time.Millisecond)
	if got := queueStageWait(received, turnStart); got != 1500*time.Millisecond {
